...
p1 = plot(xx,Record_MinR_MM, 'Color', [255,0,0]./255,  'Linestyle', '-',  'Marker', '^'   , 'Linewidth', linewidth);
p2 = plot(xx,Record_MinR_FF_RIS, 'Color', [0,255,0]./255,  'Linestyle', '-',  'Marker', 's' , 'Linewidth', linewidth);
p3 = plot(xx,Record_MinR_NF_RIS, 'Color', [0,0,255]./255,  'Linestyle', '-',  'Marker', 'd'  , 'Linewidth', linewidth);
...
legend([p1,p3,p2,p6], {'Đề xuất đa tia', 'Kênh tia cận trường','Kênh tia viễn trường','Thiết kế pha ngẫu nhiên'},'fontsize',legend_fontsize)
xlabel('Tỷ số tín hiệu/nhiễu SNR [dB]','fontsize',label_fontsize)
